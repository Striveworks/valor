...
def test_counts_metrics_first_class(basic_detections_first_class: Evaluator):
    """
...
def test_counts_metrics_second_class(basic_detections_second_class: Evaluator):
    """
    Basic object detection test.
