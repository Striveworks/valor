            ...
            return """```json
{
    ...
    monkeypatch.setattr(
        "valor_lite.text_generation.llm_clients.LLMClient.__call__",
...
def test_LLMClient_retries(monkeypatch):
    ...
    monkeypatch.setattr(
        "valor_lite.text_generation.llm_clients.WrappedOpenAIClient.__call__",
        Mock(side_effect=errors),
    )
    ...
    monkeypatch.setattr(
        "valor_lite.text_generation.llm_clients.WrappedMistralAIClient.__call__",
        Mock(side_effect=errors),
    )
