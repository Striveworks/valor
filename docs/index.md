...
**A.** Valor currently supports generic classification and ranking/information retrieval, as well as object detection and semantic segmentation for images. The long-term goal for Valor is to support the most popular supervised learning methods.
