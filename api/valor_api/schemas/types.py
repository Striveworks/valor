...
def _match_annotation_to_implied_task_type(
    ...
    if (
        ...
        and annotation.contexts is None
    ):
    ...
    # text generation tasks only support text and optionally contexts
    elif (
    ...
    # empty annotations shouldn't contain anything
        ...
        raise ValueError(
            "Input didn't match any known patterns. Classification tasks should only contain labels. Object detection tasks should contain labels and polygons, bounding boxes, or rasters with is_instance == True. Segmentation tasks should contain labels and rasters with is_instance != True. Text generation tasks should only contain text and optionally contexts."
        )
