        ...
        GroundTruth(
            ...
            annotations=[
                Annotation(
                    is_instance=True,
                    labels=[Label(key="k1", value="v1")],
                    bounding_box=Box([rect1_rotated_5_degrees_around_origin]),
                ),
                Annotation(
                    is_instance=True,
                    labels=[Label(key="k2", value="v2")],
                    bounding_box=Box([rect3_rotated_5_degrees_around_origin]),
                ),
            ],
        ),
        GroundTruth(
            ...
            annotations=[
                Annotation(
                    is_instance=True,
                    labels=[Label(key="k1", value="v1")],
                    bounding_box=Box([rect2_rotated_5_degrees_around_origin]),
                )
            ],
        ),
    ]
