    ...
    baseline_expected_metrics = [
        ...
        },
        {
            ...
            "value": {
                "v1": {
                    "0.1": {
                        "fn": 1,  # one fn, one tp with score .3
                        "fp": 0,
                        "tp": 1,
                        "recall": 0.5,
        ...
        },
        {
            ...
            "value": {
                "v2": {
                    "0.1": {
                        "fn": 1,  # missed prediction on img1
                        "fp": 1,  # bad prediction on img2
                        "tp": 0,
                        "recall": 0.0,
                        "f1_score": -1,
                        "precision": 0.0,
    ...
    foo_expected_metrics_with_higher_score_threshold = [
        ...
        },
        {
            ...
            "value": {
                "bar": {
                    "0.1": {
                        "fn": 1,  # missed rect3 on img1
                        "fp": 0,
                        "tp": 2,  # scores of .98 and .3
