...
def content_gen_predictions() -> list[str]:
    return [
        """I am a ghost living in a house. The squirrel and the squirrel asked the boy his name. The color of the sky is blue. In the morning, I ate a bagel ate a bagel. Finally, she walks away.""",
