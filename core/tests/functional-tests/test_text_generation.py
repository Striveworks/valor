...
@patch(
    "valor_core.llm_clients.WrappedOpenAIClient.answer_relevance",
    mocked_answer_relevance,
)
@patch(
    "valor_core.llm_clients.WrappedOpenAIClient.bias",
    mocked_bias,
)
@patch(
    "valor_core.llm_clients.WrappedOpenAIClient.context_precision",
    mocked_context_precision,
)
@patch(
    "valor_core.llm_clients.WrappedOpenAIClient.context_recall",
    mocked_context_recall,
)
@patch(
    "valor_core.llm_clients.WrappedOpenAIClient.context_relevance",
    mocked_context_relevance,
)
@patch(
    "valor_core.llm_clients.WrappedOpenAIClient.faithfulness",
    mocked_faithfulness,
)
@patch(
    "valor_core.llm_clients.WrappedOpenAIClient.hallucination",
